\section{Baseline without Middleware (75 pts)\label{sec:2}}
    ...
    \subsection{One Server\label{subsec:2_one-server}}
        ...
        % This experiment includes three instances of \cli{} and one instance of \srv{}. \mw{} instances are not used.
        % Each \cli{} starts a single instance of memtier with two threads connecting with a variable amount of
        % virtual clients to the single memcached instance. The virtual client amount can be inferred from the graphs.
    ...
    \subsection{Two Servers\label{subsec:2_two-servers}}
        ...
        % This experiment includes one instance of \cli{} and two instances of \srv{}. The \cli{} starts two instance
        % of memtier, each running with a single thread. Each thread connects using a variable amount of virtual
        % clients to one memcached instance.
    ...
    \subsection{Summary\label{subsec:23_summary}}
        ...
        The behaviour of slower reads than writes may be peculiar at first but verifying the machine configuration
